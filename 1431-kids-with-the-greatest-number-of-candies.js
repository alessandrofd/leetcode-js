...
const kidsWithCandies_sort = (candies, extraCandies) => {
  sortedCandies = [...candies].sort((a, b) => b - a)
  mostCandies = sortedCandies[0]
  result = []
  for (const childCandies of candies)
    if (childCandies >= mostCandies - extraCandies) result.push(true)
