...
const reverseBetween = (head, left, right) => {
  ...
  /**
   * O primeiro nó da faixa a ser invertida vai caminhando à direita, a cada
   * passo ele substitui a posição do nó à sua direita que, por sua vez, passa a
   * ocupar a primeira posição na faixa invertida, empurrando o restante da
